package com.ixiyou.air.managers 
{
	...
	/**
	 * 窗口管理器  比AIRWindowsLister功能更多更强大点
	 * @author spe
	 */
	public class AIRWindowsManager extends Singleton
	{
		...
		public function add(value:NativeWindow,id:String='',closeQuerist:Boolean=false):void {
			if (!contains(value)) {
				...
				//trace('改:',_dic[value].closeQuerist,closeQuerist)
			}	
		}
		/**
		 * 获取对象在字典里的属性
		 ...
		 * @param	value
		 */
		public function addEvent(value:NativeWindow):void {
		 ...
		 * @param	value
		 */
		public function removeEvent(value:NativeWindow):void {
		...
		private function closeIng(e:Event):void 
		{
			...
			if (_dic[win] != null) {
				...
				//trace('closeQuerist:',obj.closeQuerist)
