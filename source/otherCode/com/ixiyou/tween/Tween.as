...
package  com.ixiyou.tween
{
	...
	import flash.geom.*;
	//
	import com.ixiyou.tween.events.TDataSpeEvent;
	public class Tween extends EventDispatcher
	{
		...
		protected function tweenHandler(e:TimerEvent):void
		{
			...
			dispatchEvent(new TDataSpeEvent('tween', _currentProps));
		...
		public function stop(state:int=0):void
		{
			...
			//
			dispatchEvent(new TDataSpeEvent('complete', _currentProps));
		...
		public static function alpha2(mc:*, propDest_a:Number, timeSeconds:Number=2, animType:String="linear", delay:Number=0):Tween
		{
			...
			function tweenHolderHandler(e:TDataSpeEvent):void
			{
				mc.alpha = e.data[0];
