package com.ixiyou.utils
{
	...
	*/
	...
	public class StringUtil
	{
		 ...
		 * @return
		 */
		public static function force2Digits(value:Number):String {
		...
		*/
		 ...
		 * 是否中文与英文
		 */
		public static function  isEnglishOrChinese(value:String):Boolean
		{
			var pattern:RegExp
			pattern= /[0-9]/ig;
			if(!pattern.test(value)){
				var pattern1:RegExp =/[\u4e00-\u9fa5]|[a-zA-z]/ig;
		 ...
		 * @return
		 */
		public static function is_mobile(value:String):Boolean{
			var pattern:RegExp = /^0?(13|14|15|18)\d{9}$/ig;
		 ...
		 * @return
		 */
		public static function isCardID(value:String):Boolean{
			var pattern:RegExp = /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])(\d{4}|\d{3}[Xx])$/ig;
			return pattern.test(value)
		}
		/**
		 * 是否车牌
		 * @param	value 赣B00111
		 */
		public static function isLicensePlate(value:String):Boolean {
			var pattern:RegExp = /([\u4e00-\u9fa5])([a-zA-Z])([a-z0-9A-Z]){5}$/ig;
			return pattern.test(value)
		}
	}
}
