package com.ixiyou.speUI.mcontrols 
{
	...
	public class MovieToComboBox extends Sprite 
	{
		 ...
		 * @return
		 */
		public function removeItemByProperty(value:*,label:String='label'):Object {
			if(!data)return null
			var i:uint
			var obj:Object
			for (i = 0; i < data.length; i++) 
		 ...
		 * @return
		 */
		public function getDataByProperty(value:*,label:String = 'label'):Object {
			if(!data)return null
			var i:uint
			var obj:Object
			for (i = 0; i < data.length; i++) 
		...
		public function upSelet(value:*):void {
		 ...
		 * @return
		 */
		public function setSelectByProperty(value:*, label:String = 'label'):Object {
			var obj:Object = getDataByProperty(value, label)
			upSelet(obj)
			return obj
		}
